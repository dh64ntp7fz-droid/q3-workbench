...
{ name: '包间预订系统', path: path.join(home, 'room-reservation-supabase'), tech: 'Node.js + Supabase + Render', icon: '📅', desc: '5店包间预订管理，每日自动推送4次', category: '🌐 在线系统', url: 'https://room-reservation-davw.onrender.com', url_tx: 'http://101.33.212.238/', url_local: 'file:///Users/johnny/room-reservation-supabase' },
    ...
    { name: '生日宴记录系统', path: path.join(home, 'AI知识库/03_项目推进/生日宴记录系统'), tech: 'Node.js + 腾讯云', icon: '🎂', desc: '生日场景客人资产记录，门店高价值场景', category: '🌐 在线系统', url_tx: 'http://101.33.212.238/birthday/', url_local: 'file:///Users/johnny/AI知识库/03_项目推进/生日宴记录系统' },
    { name: '环球每日进货量登记系统', path: path.join(home, 'hq-purchase'), tech: 'FastAPI + PostgreSQL · 腾讯云', icon: '📦', desc: '各责任人每日进货量登记→企微推送；每月10/20/月底自动汇总', category: '🌐 在线系统', url_tx: 'http://101.33.212.238/purchase/', url_admin: 'http://101.33.212.238/purchase/admin', url_local: 'file:///Users/johnny/hq-purchase' },
    { name: '员工生日日历', path: null, tech: 'WorkBuddy', icon: '🎈', desc: '员工生日提醒与生日分布查看', category: '🌐 在线系统', url: 'https://d373e6aa4142497185458a206b65b7b4.app.workbuddy.link/' },
    // ── 独立部署页面 ──
